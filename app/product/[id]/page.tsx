...
const ProductPage = async ({ params }: ProductPageProps) => {
  ...
  return (
    <div className="bg-[#fcfbf7] min-h-screen lg:h-[calc(100vh-80px)] w-full flex items-center justify-center p-4 lg:p-8 overflow-hidden">
      ...
      <main className="w-full h-full max-w-[1600px] mx-auto flex flex-col">
        {/* Breadcrumbs for SEO and Navigation */}
        <Breadcrumbs
          items={[
            { label: 'Productos', href: '/artisans' },
            { label: product.category, href: `/artisans?category=${product.category}` },
            { label: product.title }
          ]}
        />
