...
export default function LoginForm() {
  // state puede ser undefined inicialmente
    ...
    <div className="max-w-md w-full mx-auto p-6 bg-white rounded-lg shadow-md border">
      ...
      <form action={dispatch} className="space-y-4">
        <div>
          ...
          />
          {/* Solución al error de TS: verificar si 'email' existe en el objeto error */}
      ...
      <form action={loginGoogle}>
        <button
          type="submit"
          className="w-full py-2 px-4 border border-gray-300 rounded flex items-center justify-center gap-2 hover:bg-gray-50 text-black transition-colors"
        >
