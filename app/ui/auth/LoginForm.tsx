  ...
  return (
    <div className="max-w-md w-full mx-auto p-6 bg-white rounded-lg shadow-md border">
      ...
      <form action={dispatch} className="space-y-4">
        ...
        <button type="submit" className="w-full py-2 px-4 bg-gray-900 text-white rounded hover:bg-gray-800">
          Sign In
        </button>
      </form>
      ...
      {/* Botón de Google (Server Action Separada) */}
      <form action={loginGoogle}>
        <button type="submit" className="w-full py-2 px-4 border border-gray-300 rounded flex items-center justify-center gap-2 hover:bg-gray-50 text-black">
          {/* Icono de Google SVG */}
