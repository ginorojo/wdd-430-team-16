...
// Sugerencia: Define un tipo estricto para tu producto para mejorar la seguridad y el autocompletado.
type Product = {
  id: string;
  image: string;
  title: string;
...
export default function ProductRow({ product }: { product: Product }) {
  ...
  return (
    <>
        ...
        <td colSpan={5} className="p-0">
          <div className="bg-white p-4 border-b border-gray-100 flex items-center gap-4">
            ...
            <div className="grow min-w-0">
              <h4 className="font-bold text-[#283618] truncate">
                {product.title}
              </h4>
      ...
      {/* --- MODALS --- */}
      {/* Se mueven los modales fuera de la estructura <tr> para evitar errores de hidratación en React.
          Al usar `position: fixed`, su ubicación en el DOM no afecta su posicionamiento visual. */}
      {isDeleteModalOpen && (
